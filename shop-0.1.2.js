...
},{"../../../shared/dist/lib/env":128,"../../../shared/dist/lib/loadUiClassHtml":129,"../../../shared/dist/lib/shipping":130,"../../../shared/dist/lib/tools/currency":132,"../../../shared/dist/lib/types":136,"../templates/UiCart.html":118,"../templates/UiCart.less":119,"ts-events-extended":117}],2:[function(require,module,exports){
"use strict";
...
var UiShippingAddress_1 = require("./UiShippingAddress");
...
var UiController = /** @class */ (function () {
    function UiController(defaultCountryIso) {
        ...
        {
            var uiShippingAddress_1 = new UiShippingAddress_1.UiShippingAddress();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            place = _a.sent();
                            console.log(place);
                            this.interact_checkout(uiCart.getCart(), uiShipTo.shipToCountryIso, uiCurrency.currency);
                            return [2 /*return*/];
                    }
                });
            }); });
    ...
    UiController.prototype.interact_checkout = function (cart, shipToCountryIso, currency) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, stripePublicApiKey, sessionId, stripe, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (1 === 1) {
                            console.log("checkout avoid");
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, webApiCaller.createStripeCheckoutSession(cart, shipToCountryIso, currency)];
                    case 1:
...
},{"../../../shared/dist/lib/env":128,"../../../shared/dist/lib/loadUiClassHtml":129,"../../../shared/dist/lib/shopProducts":131,"../../../shared/dist/lib/tools/currency":132,"../../../shared/dist/lib/webApiCaller":137,"../templates/UiController.html":120,"./UiCart":1,"./UiCurrency":3,"./UiProduct":4,"./UiShipTo":5,"./UiShippingAddress":6}],3:[function(require,module,exports){
"use strict";
...
},{"../../../shared/dist/lib/loadUiClassHtml":129,"../../../shared/dist/lib/tools/currency":132,"../templates/UiCurrency.html":121,"../templates/UiCurrency.less":122,"ts-events-extended":117}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var loadUiClassHtml_1 = require("../../../shared/dist/lib/loadUiClassHtml");
var ts_events_extended_1 = require("ts-events-extended");
...
},{"../../../shared/dist/lib/loadUiClassHtml":129,"../../../shared/dist/lib/shipping":130,"../../../shared/dist/lib/tools/currency":132,"../../../shared/dist/lib/types":136,"../templates/UiProduct.html":123,"../templates/UiProduct.less":124,"ts-events-extended":117}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var loadUiClassHtml_1 = require("../../../shared/dist/lib/loadUiClassHtml");
var ts_events_extended_1 = require("ts-events-extended");
...
},{"../../../shared/dist/lib/loadUiClassHtml":129,"../templates/UiShipTo.html":125,"../templates/UiShipTo.less":126,"ts-events-extended":117}],6:[function(require,module,exports){
"use strict";
...
var html = loadUiClassHtml_1.loadUiClassHtml(require("../templates/UiShippingAddress.html"), "UiShippingAddress");
var UiShippingAddress = /** @class */ (function () {
    /**
     ...
     */
    function UiShippingAddress() {
        var _this = this;
        this.structure = html.structure.clone();
        this.evtClose = new ts_events_extended_1.VoidSyncEvent();
        this.isInitialized = false;
        this.evtPlace = new ts_events_extended_1.SyncEvent();
        ...
        this.hideModal = hide;
        this.showModal = show;
        this.structure.find(".id_close").on("click", function () { return _this.evtClose.post(); });
        this.evtClose.attach(function () { return _this.hideModal(); });
    }
    UiShippingAddress.prototype.interact_getAddress = function () {
        return __awaiter(this, void 0, void 0, function () {
            var resolvePrOut, prOut, isGoogleMapScriptReady, autocomplete_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        prOut = new Promise(function (resolve) { return resolvePrOut = resolve; });
                        this.evtPlace.attachOnce(function (place) { return __awaiter(_this, void 0, void 0, function () {
                            var _this = this;
                            return __generator(this, function (_a) {
                                return [2 /*return*/, this.structure.find("button")
                                        .removeAttr("disabled")
                                        .one("click", function () { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                        ...
                        this.evtClose.attachOnce(function () { return resolvePrOut(undefined); });
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!!isGoogleMapScriptReady()) return [3 /*break*/, 4];
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 2];
                    case 4:
                        autocomplete_1 = new google.maps.places.Autocomplete(this.structure.find("input").get(0), { "types": ["geocode"] });
                        autocomplete_1.setFields(["address_component"]);
                        autocomplete_1.addListener("place_changed", function () { return _this.evtPlace.post(autocomplete_1.getPlace()); });
                        this.isInitialized = true;
                        _a.label = 5;
                    case 5: return [2 /*return*/, prOut];
                }
            });
        });
    };
    return UiShippingAddress;
}());
exports.UiShippingAddress = UiShippingAddress;

},{"../../../shared/dist/lib/loadUiClassHtml":129,"../../../shared/dist/lib/tools/modal_stack":134,"../templates/UiShippingAddress.html":127,"ts-events-extended":117}],7:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
},{"../../../shared/dist/lib/tools/currency":132,"../../../shared/dist/lib/tools/standalonePolyfills":135,"../../../shared/dist/lib/webApiCaller":137,"./UiController":2,"array.prototype.find":9,"es6-map/implement":82,"es6-weak-map/implement":93}],8:[function(require,module,exports){
'use strict';
...
},{"es-abstract/es6":19}],9:[function(require,module,exports){
'use strict';
...
},{"./implementation":8,"./polyfill":10,"./shim":11,"define-properties":15,"es-abstract/es6":19}],10:[function(require,module,exports){
'use strict';
...
},{"./implementation":8}],11:[function(require,module,exports){
'use strict';
...
},{"./polyfill":10,"define-properties":15}],12:[function(require,module,exports){
...
},{"es5-ext/object/copy":52,"es5-ext/object/map":61,"es5-ext/object/normalize-options":62,"es5-ext/object/valid-callable":67,"es5-ext/object/valid-value":69}],14:[function(require,module,exports){
'use strict';
...
},{"es5-ext/object/assign":49,"es5-ext/object/is-callable":55,"es5-ext/object/normalize-options":62,"es5-ext/string/#/contains":70}],15:[function(require,module,exports){
'use strict';
...
},{"object-keys":109}],16:[function(require,module,exports){
'use strict';
...
},{"./GetIntrinsic":16,"./es5":18,"./helpers/assertRecord":20,"./helpers/assign":21,"./helpers/isFinite":22,"./helpers/isNaN":23,"./helpers/isPrimitive":24,"./helpers/mod":25,"./helpers/sign":26,"es-to-primitive/es6":29,"function-bind":99,"has":102,"is-regex":105,"object-keys":109}],18:[function(require,module,exports){
'use strict';
...
},{"./GetIntrinsic":16,"./helpers/assertRecord":20,"./helpers/isFinite":22,"./helpers/isNaN":23,"./helpers/mod":25,"./helpers/sign":26,"es-to-primitive/es5":28,"has":102,"is-callable":103}],19:[function(require,module,exports){
'use strict';

module.exports = require('./es2015');

},{"./es2015":17}],20:[function(require,module,exports){
'use strict';
...
},{"../GetIntrinsic":16,"has":102}],21:[function(require,module,exports){
var bind = require('function-bind');
...
},{"function-bind":99}],22:[function(require,module,exports){
...
},{"./helpers/isPrimitive":30,"is-callable":103,"is-date-object":104,"is-symbol":106}],28:[function(require,module,exports){
'use strict';
...
},{"./helpers/isPrimitive":30,"is-callable":103}],29:[function(require,module,exports){
arguments[4][19][0].apply(exports,arguments)
},{"./es2015":27,"dup":19}],30:[function(require,module,exports){
...
},{"../../object/valid-value":69}],32:[function(require,module,exports){
"use strict";
...
},{"../../number/is-nan":43,"../../number/to-pos-integer":47,"../../object/valid-value":69}],33:[function(require,module,exports){
"use strict";
...
},{"../../function/is-arguments":36,"../../function/is-function":37,"../../number/to-pos-integer":47,"../../object/is-value":57,"../../object/valid-callable":67,"../../object/valid-value":69,"../../string/is-string":73,"es6-symbol":88}],36:[function(require,module,exports){
"use strict";
...
},{"./valid-callable":67,"./valid-value":69}],49:[function(require,module,exports){
"use strict";
...
},{"../keys":58,"../valid-value":69}],52:[function(require,module,exports){
"use strict";
...
},{"../array/from":33,"./assign":49,"./valid-value":69}],53:[function(require,module,exports){
...
},{"../create":53,"../is-object":56,"../valid-value":69}],67:[function(require,module,exports){
"use strict";
...
},{"./is-object":56}],69:[function(require,module,exports){
"use strict";
...
},{"./is-value":57}],70:[function(require,module,exports){
"use strict";
...
},{"./":78,"d":14,"es5-ext/object/set-prototype-of":64,"es5-ext/string/#/contains":70,"es6-symbol":88}],76:[function(require,module,exports){
"use strict";
...
},{"./get":77,"es5-ext/function/is-arguments":36,"es5-ext/object/valid-callable":67,"es5-ext/string/is-string":73}],77:[function(require,module,exports){
"use strict";
...
},{"./array":75,"./string":80,"./valid-iterable":81,"es5-ext/function/is-arguments":36,"es5-ext/string/is-string":73,"es6-symbol":88}],78:[function(require,module,exports){
"use strict";
...
},{"d":14,"d/auto-bind":13,"es5-ext/array/#/clear":31,"es5-ext/object/assign":49,"es5-ext/object/valid-callable":67,"es5-ext/object/valid-value":69,"es6-symbol":88}],79:[function(require,module,exports){
"use strict";
...
},{"es5-ext/function/is-arguments":36,"es5-ext/object/is-value":57,"es5-ext/string/is-string":73,"es6-symbol":88}],80:[function(require,module,exports){
...
},{"./":78,"d":14,"es5-ext/object/set-prototype-of":64,"es6-symbol":88}],81:[function(require,module,exports){
"use strict";
...
},{"./is-implemented":83,"./polyfill":87,"es5-ext/global":39}],83:[function(require,module,exports){
'use strict';
...
},{"es5-ext/object/primitive-set":63}],86:[function(require,module,exports){
'use strict';
...
},{"./iterator-kinds":85,"d":14,"es5-ext/object/set-prototype-of":64,"es6-iterator":78,"es6-symbol":88}],87:[function(require,module,exports){
'use strict';
...
},{"./is-native-implemented":84,"./lib/iterator":86,"d":14,"es5-ext/array/#/clear":31,"es5-ext/array/#/e-index-of":32,"es5-ext/object/set-prototype-of":64,"es5-ext/object/valid-callable":67,"es5-ext/object/valid-value":69,"es6-iterator/for-of":76,"es6-iterator/valid-iterable":81,"es6-symbol":88,"event-emitter":97}],88:[function(require,module,exports){
'use strict';
...
},{"./validate-symbol":92,"d":14}],92:[function(require,module,exports){
'use strict';
...
},{"./is-implemented":94,"./polyfill":96,"es5-ext/global":39}],94:[function(require,module,exports){
'use strict';
...
},{"./is-native-implemented":95,"d":14,"es5-ext/object/set-prototype-of":64,"es5-ext/object/valid-object":68,"es5-ext/object/valid-value":69,"es5-ext/string/random-uniq":74,"es6-iterator/for-of":76,"es6-iterator/get":77,"es6-symbol":88}],97:[function(require,module,exports){
'use strict';
...
},{"d":14,"es5-ext/object/valid-callable":67}],98:[function(require,module,exports){
'use strict';
...
},{"has":102}],106:[function(require,module,exports){
'use strict';
...
},{"has-symbols":100}],107:[function(require,module,exports){
module.exports = require('cssify');

},{"cssify":12}],108:[function(require,module,exports){
'use strict';
...
},{"./SyncEventBase":114}],114:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"./SyncEventBaseProtected":115}],115:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
},{"./defs":116,"run-exclusive":111}],116:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"setprototypeof":112}],117:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
},{"./tools/currency":132,"./tools/isAscendingAlphabeticalOrder":133}],137:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
},{"dup":98}],140:[function(require,module,exports){
arguments[4][99][0].apply(exports,arguments)
},{"./implementation":139,"dup":99}],141:[function(require,module,exports){
arguments[4][102][0].apply(exports,arguments)
},{"dup":102,"function-bind":140}],142:[function(require,module,exports){
(function (global){
"use strict";
var has = require('has');
